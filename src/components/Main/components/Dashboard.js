...
const Dashboard = () => {
    const {customer, product} = useContext(GlobalStateContext);
    console.log(product)
    return(
                        ...
                        <div className="flex flex-wrap -mx-6">
                            <div className="w-full px-6 sm:w-1/2 xl:w-1/3">
                                <div className="flex items-center px-5 py-6 shadow-sm rounded-md bg-white">
                                    ...
                                    <div className="mx-5">
                                        <h4 className="text-2xl font-semibold text-gray-700">{customer?customer.length:0}</h4>
                            ...
                            <div className="w-full mt-6 px-6 sm:w-1/2 xl:w-1/3 xl:mt-0">
                                <div className="flex items-center px-5 py-6 shadow-sm rounded-md bg-white">
                                    ...
                                    <div className="mx-5">
                                        <h4 className="text-2xl font-semibold text-gray-700">{product?product.length:0}</h4>
